...
def forecast_and_visualize(X, model, selected_product, feature_engineered_data):
    ...
    # Use the feature_engineering function to add the season and holiday features
    ...
    # Only plot the last 14 days of actual data
    ax.plot(y.index[-14:], y.values[-14:], label='Actuals')
...
if st.button("Show Forecast"):
    ...
    # Generate a forecast for the selected product
